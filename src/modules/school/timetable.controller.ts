...
/**
 * Time table (Phase 3). Roles are per-handler: reads open to staff who touch
 * the class, writes stay principal/ADMIN (plan §3.3). Cross-tenant and
 * unauthorized access both surface as 404 from the service (rule D1).
 */
